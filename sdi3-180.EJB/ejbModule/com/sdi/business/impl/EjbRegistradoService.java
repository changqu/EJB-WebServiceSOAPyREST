...
import com.sdi.business.impl.classes.registrado.FindTrip;
import com.sdi.business.impl.classes.registrado.FindUser;
...
@Stateless
@WebService(name="RegistradoService") 
public class EjbRegistradoService implements LocalRegistradoService, RemoteRegistradoService{
	...
	public User findUserByLogin(String login) {
		return new FindUser().findLogin(login);
	}
	
	@Override
	public User findUserById(Long id) {
		return new FindUser().findId(id);
	}

	@Override
	public Trip findTripById(Long id) {
		return new FindTrip().find(id);
	}

	@Override
	public List<Trip> viajesComoParticiapante(User u) {
		return new ViajesRelacionados().viajesComoParticipante(u);
	}
